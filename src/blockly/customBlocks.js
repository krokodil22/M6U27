...
export function registerBlocks(){
 ...
 Blockly.Blocks.change_var={init(){this.appendValueInput('VALUE').setCheck('Number').appendField('изменить').appendField(new Blockly.FieldDropdown([['болтики','болтики'],['топливо','топливо']]),'VAR').appendField('на');this.setPreviousStatement(true);this.setNextStatement(true);this.setColour(32)}};
 Blockly.Blocks.set_var={init(){this.appendValueInput('VALUE').setCheck('Number').appendField('установить').appendField(new Blockly.FieldDropdown([['болтики','болтики'],['топливо','топливо']]),'VAR').appendField('в');this.setPreviousStatement(true);this.setNextStatement(true);this.setColour(32)}};
